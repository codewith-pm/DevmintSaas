...
const Dashboard: React.FC = () => {
  ...
  const recentInvoices = [
    { id: 'INV-001', client: 'Acme Corp', amount: '$1,250.00', status: 'paid', date: '2024-12-15' },
    { id: 'INV-002', client: 'Tech Solutions', amount: '$850.00', status: 'pending', date: '2024-12-14' },
    { id: 'INV-003', client: 'StartupXYZ', amount: '$2,100.00', status: 'paid', date: '2024-12-13' }
  ];
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <div className="bg-white p-6 rounded-2xl shadow-lg">
          <div className="flex items-center justify-between mb-4">
            ...
            <span className="text-2xl font-bold text-gray-900">{apiUsage.current}</span>
          </div>
          <div className="mb-2">
            <div className="flex justify-between text-sm text-gray-600 mb-1">
              <span>API Calls</span>
              <span>{apiUsage.current}/{apiUsage.limit}</span>
            </div>
        ...
        <div className="bg-white p-6 rounded-2xl shadow-lg">
          ...
          <p className="text-yellow-600 text-xs capitalize">Upgrade available</p>
        </div>
      </div>
          ...
          <div className="space-y-4">
            ...
            <Link to="/dashboard/subscription" className="flex items-center p-4 bg-green-50 rounded-xl hover:bg-green-100 transition-colors">
              ...
              <div>
                ...
                <div className="text-sm text-gray-600">Access more features</div>
              </div>
            </Link>
          </div>
        </div>
    ...
    return (
      <div className="space-y-6">
        <div>
          ...
          <p className="text-gray-600">Manage your ApiForge subscription and billing</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-gray-50 rounded-xl p-4">
              <div className="text-2xl font-bold text-gray-900 mb-2">{user.plan === 'free' ? 'Basic' : 'Premium'}</div>
              <div className="text-gray-600 text-sm">Invoice Templates</div>
            </div>
            <div className="bg-gray-50 rounded-xl p-4">
              <div className="text-2xl font-bold text-gray-900 mb-2">{user.plan === 'enterprise' ? '24/7' : 'Email'}</div>
              ...
              {user.plan === 'free' && (
                <div className="border-2 border-blue-600 rounded-xl p-6 bg-blue-50">
                  ...
                  <ul className="space-y-3 mb-6 text-gray-700">
                    ...
                    <li className="flex items-center"><CheckCircle className="w-5 h-5 text-green-500 mr-2" />Premium templates</li>
