      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 mb-8">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <p className="text-gray-700 mb-6">
              By accessing or using ApiForge services ("Service"), you agree to be bound by these Terms of Service ("Terms"). 
            ...
            <p className="text-gray-700 mb-4">
              ApiForge provides API services including but not limited to:
            </p>
            ...
            <ul className="list-disc list-inside text-gray-700 mb-6 space-y-2">
              ...
              <li>Rate limits are enforced to ensure service availability</li>
            ...
            <p className="text-gray-700 mb-6">
              ...
              maintenance that temporarily affects service availability. We will provide advance notice of 
              scheduled maintenance when possible.
            </p>

            <h2 className="text-2xl font-bold text-gray-900 mb-4">9. Intellectual Property</h2>
            <p className="text-gray-700 mb-6">
              The Service and its original content, features, and functionality are owned by ApiForge and are 
            ...
            <p className="text-gray-700 mb-6">
              To the maximum extent permitted by law, ApiForge shall not be liable for any indirect, incidental, 
            ...
            <div className="bg-gray-50 rounded-xl p-4">
              <p className="text-gray-700">
                <strong>Email:</strong> legal@apiforge.com<br />
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6">
          ...
          <div className="text-sm text-gray-600 space-y-2">
            <p><strong>Version 2.1</strong> - December 2024: Updated Paddle.com integration terms</p>
