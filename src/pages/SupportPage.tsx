  ...
  const faqs = [
    {
      id: 1,
      category: 'api',
      question: 'How do I get started with the ApiForge APIs?',
              ...
              <div className="space-y-4">
                <div className="flex items-center p-4 bg-blue-50 rounded-xl">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-600">support@apiforge.com</div>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <div className="text-sm text-red-700">
                    <strong>Phone:</strong> +1 (555) 911-HELP<br />
                    <strong>Email:</strong> emergency@apiforge.com
                  </div>
                </div>
              </div>
            </div>
