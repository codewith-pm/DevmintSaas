      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 mb-8">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <p className="text-gray-700 mb-6">
              We stand behind our service and want you to be completely satisfied with ApiForge. Our refund policy 
            ...
            <div className="space-y-6 mb-8">
              <div className="flex items-start space-x-4 p-4 bg-gray-50 rounded-xl">
                ...
                <div>
                  ...
                  <p className="text-gray-700 text-sm">
                    Contact our support team at <strong>billing@apiforge.com</strong> with your account details 
            ...
            <p className="text-gray-700 mb-4">
              ...
              to future billing periods. These credits never expire and can be used for any ApiForge service.
            </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <p className="text-gray-700 text-sm mb-2">
                    <strong>Email:</strong> billing@apiforge.com
                  </p>
                  <p className="text-gray-700 text-sm mb-2">
                    <strong>Response time:</strong> Within 4 hours during business days
                  </p>
                  <p className="text-gray-700 text-sm">
                    <strong>Phone:</strong> +1 (555) 123-4567 (Enterprise customers only)
                  </p>
                </div>
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6">
          <div className="text-center">
            ...
            <a 
              href="mailto:billing@apiforge.com" 
